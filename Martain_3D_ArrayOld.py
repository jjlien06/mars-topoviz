...
resultFileName = inputfilename + "-"+ str(x_max) +"x"+str(y_max)+'x'+str(z_max)
filePath = os.getcwd() + "/Topography_Tensors/"""

def createTensor(x_max, y_max, z_max, AltResolution, file):
    filePath = os.getcwd() + "/Topography_Tensors/"
    resultFile = open(filePath + file, "ab")
    ...
    topography_array = np.array([[[1]*x_max]*y_max]*z_max)
